        ...
        {c.projects.map((p) => {
          ...
          return (
            <div
              ...
              className={`flex scroll-mt-4 flex-col overflow-hidden rounded-[10px] border bg-white ${isMine ? "border-green" : "border-border"} ${p.id === focusId ? "ring-2 ring-green/70 ring-offset-2 ring-offset-bg" : ""}`}
            >
              {p.imageUrl ? (
